// Base de dados educacional com linguagem acessível, analogias do dia a dia e sem emojis
const TUTORIAL_DATA = {
    projectInfo: {
        title: "Guia Visual e Prático de POO",
        subtitle: "Aprenda Programação Orientada a Objetos de forma simples e intuitiva, usando como exemplo real o código de um Cassino em Java.",
        repository: "guilhermecunha777/cassino",
        language: "Java 21",
        paradigm: "Programação Orientada a Objetos"
    },
    stages: [
        {
            id: 1,
            ...
            analogy: "Pense em uma Classe como uma fôrma de bolo ou a ficha em branco de um novo sócio em um clube. Ela não é o bolo em si, mas define exatamente quais ingredientes (nome, CPF, senha e saldo) todo sócio precisa ter.",
            pooConcepts: [
                { name: "Classe", desc: "A 'planta da casa' ou 'fôrma' que define como todo usuário deve ser construído." },
                { name: "Atributos", desc: "As informações guardadas na memória (como o nome da pessoa ou quanto dinheiro ela tem)." },
                { name: "Construtor", desc: "A 'certidão de nascimento': o código que roda no momento exato em que o usuário é criado." },
                { name: "Encapsulamento", desc: "O 'cofre': protege o saldo para que ninguém altere o dinheiro diretamente sem autorização." }
            ],
            whyItExists: "Em qualquer programa, antes de criar telas, botões ou jogos, precisamos saber com o que estamos lidando. O cassino gira em torno do apostador. Criamos o Usuario primeiro para que o sistema consiga guardar quem está jogando e acompanhar o saldo de forma segura.",
...
public class SaldoMenu {
    ...
    public void iniciar() {
        ...
        },
        {
            ...
            pooConcepts: [
                { name: "Separação de Funções", desc: "Cada classe tem uma única missão bem definida, tornando o código mais fácil de consertar." },
